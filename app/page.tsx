export default function Home() {
  return (
    <main className="relative min-h-screen bg-black text-white overflow-x-hidden">
      ...
      {/* HERO */}
      <section className="relative z-10 px-6 md:px-14 pt-40 pb-32">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-neutral-500 tracking-[0.3em] text-sm mb-8">
              BIM STUDIO — SWEDEN
            </p>

            <h2 className="text-6xl md:text-8xl font-semibold leading-[0.9]">
              Vormexa
            </h2>

            <p className="text-3xl md:text-5xl font-semibold leading-tight mt-10 max-w-3xl">
              Intelligent BIM Coordination & Visualization
            </p>

            <p className="text-neutral-400 mt-10 text-lg leading-relaxed max-w-xl">
            ...
            <div className="flex flex-wrap gap-5 mt-14">
              <a
                href="#systems"
                className="px-8 py-5 bg-white text-black rounded-full hover:bg-neutral-200 transition"
              >
                Explore Systems
              </a>
              ...
              <a
                href="#contact"
                className="px-8 py-5 border border-neutral-700 rounded-full hover:border-white transition"
              >
                Contact
              </a>
            </div>
          ...
          <div className="relative">
            <div className="relative h-[700px] rounded-[40px] overflow-hidden border border-neutral-800 bg-gradient-to-br from-neutral-950 via-black to-neutral-900">
              ...
              <div className="relative z-10 p-10 flex flex-col justify-between h-full">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-5xl md:text-6xl font-semibold leading-tight max-w-lg">
                      Intelligent BIM Coordination Environment
                    </h3>
                  </div>

                  <div className="w-24 h-24 rounded-full border border-neutral-700 flex items-center justify-center text-sm text-neutral-400">
                    BIM
                  </div>
                </div>

                <div className="grid grid-cols-2 gap-6">
                  <div className="rounded-3xl border border-neutral-800 bg-neutral-950/60 p-6 backdrop-blur-sm">
                ...
                <div className="flex justify-between items-end">
                  <div>
                    <div className="w-[220px] h-[2px] bg-neutral-800 mb-5"></div>
      ...
      <section
        id="about"
        className="relative z-10 px-6 md:px-14 py-32 border-t border-neutral-900 overflow-hidden"
      >
        ...
        <h2 className="text-4xl md:text-7xl font-semibold leading-[1.05] max-w-6xl relative z-10">
          We create intelligent BIM systems for visionary architecture and
          future-ready coordination.
        </h2>

        <p className="text-neutral-400 text-lg leading-relaxed max-w-2xl mt-16 relative z-10">
      ...
      <section
        id="process"
        className="relative z-10 px-6 md:px-14 py-32 border-t border-neutral-900"
      >
        <p className="text-neutral-500 tracking-[0.3em] text-sm mb-16">
          OUR PROCESS
        </p>
        ...
        <div className="space-y-10">
          {[
            ...
            <div
              key={number}
              className="group border border-neutral-900 rounded-[32px] p-10 hover:border-neutral-700 hover:-translate-y-2 transition-all duration-700"
            >
      ...
      <section
        ...
        className="relative z-10 px-6 md:px-14 py-32 border-t border-neutral-900"
      >
        <p className="text-neutral-500 tracking-[0.3em] text-sm mb-14">
          SERVICES
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={title}
              className="group rounded-[35px] border border-neutral-900 bg-neutral-950 p-10 hover:border-neutral-700 hover:-translate-y-2 transition-all duration-700 relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-white/[0.03] opacity-0 group-hover:opacity-100 transition duration-700"></div>

              <div className="relative h-[240px] rounded-3xl bg-gradient-to-br from-neutral-900 to-black border border-neutral-800 flex items-center justify-center mb-10">
...
<section className="relative z-10 px-6 md:px-14 py-32 border-t border-neutral-900">
  ...
  <div className="mb-20">
    ...
    <h2 className="text-5xl md:text-7xl font-semibold max-w-5xl leading-tight">
  ...
  <div className="grid md:grid-cols-2 gap-8">
    ...
    <div className="group rounded-[35px] border border-neutral-900 p-10 hover:border-neutral-700 transition-all duration-700">
    ...
    <div className="group rounded-[35px] border border-neutral-900 p-10 hover:border-neutral-700 transition-all duration-700">
      ...
      <section className="relative z-10 px-6 md:px-14 py-32 border-t border-neutral-900">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-10 mb-16">
          <div>
            ...
            <h2 className="text-5xl md:text-7xl font-semibold leading-tight max-w-4xl">
        ...
        <div className="group relative overflow-hidden rounded-[40px] border border-neutral-900 bg-neutral-950">
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent z-10"></div>

          <div className="h-[750px] bg-gradient-to-br from-neutral-900 via-black to-neutral-950 flex items-center justify-center">
          ...
          <div className="absolute bottom-0 left-0 z-20 p-10 md:p-16">
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-3 border border-neutral-700 rounded-full px-7 py-4 hover:bg-white hover:text-black transition duration-500"
            >
              Explore System
            </a>
          </div>
      ...
      <section className="relative z-10 px-6 md:px-14 py-32 border-t border-neutral-900">
        <div className="grid md:grid-cols-4 gap-8">
          {[
            ...
            <div
              key={title}
              className="border border-neutral-900 rounded-[32px] p-10 hover:border-neutral-700 hover:-translate-y-2 transition-all duration-700"
            >
        ...
        <div className="space-y-32">
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div className="relative group">
              ...
              <div className="relative h-[600px] rounded-[40px] overflow-hidden border border-neutral-900 bg-gradient-to-br from-neutral-900 via-black to-neutral-950 flex items-center justify-center hover:scale-[1.01] transition duration-700">
                <span className="text-neutral-600 tracking-[0.4em] text-sm">
            ...
            <div>
              ...
              <h2 className="text-5xl md:text-7xl font-semibold leading-[1] mb-10">
      ...
      >
        ...
        <h2 className="text-5xl md:text-7xl font-semibold leading-tight max-w-5xl">
          Let’s coordinate intelligent BIM experiences together.
        </h2>

        <div className="mt-16 flex flex-col gap-6 text-2xl">
          <a
      ...
      {/* FOOTER */}
      <footer className="relative z-10 px-6 md:px-14 py-10 border-t border-neutral-900 flex justify-between text-neutral-500 text-sm">
        <p>vormexa Techno</p>
        <p>Sweden — 2026</p>
      </footer>
    </main>
